...
public struct Global {
    ...
    public let totalMarketCapRUB: Double?
    public let totalVolumeRUB24h: Double?
...
extension Global: Encodable {
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(totalMarketCapHKD, forKey: .totalMarketCapHKD)
        try container.encode(totalVolumeHKD24h, forKey: .totalVolumeHKD24h)
        try container.encode(totalMarketCapRUB, forKey: .totalMarketCapRUB)
        try container.encode(totalVolumeRUB24h, forKey: .totalVolumeRUB24h)
    }
}
...
extension Global: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        totalMarketCapRUB = try? values.decode(Double.self, forKey: .totalMarketCapRUB)
        totalVolumeRUB24h = try? values.decode(Double.self, forKey: .totalVolumeRUB24h)
    }
}

...
extension Ticker: Encodable {
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(volumeRUB24h, forKey: .volumeRUB24h)
        try container.encode(marketCapRUB, forKey: .marketCapRUB)
    }
}
